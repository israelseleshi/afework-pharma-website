...
type Page = 'home' | 'about' | 'solutions' | 'projects' | 'contact' | 'solution-detail' | 'privacy-policy' | 'terms-of-service' | 'cookie-policy';
...
export function Router({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (['home', 'about', 'solutions', 'projects', 'contact', 'solution-detail', 'privacy-policy', 'terms-of-service', 'cookie-policy'].includes(page)) {
