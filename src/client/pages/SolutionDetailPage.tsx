...
export function SolutionDetailPage() {
  ...
  const solutionDetails = {
    "Diagnostic & Laboratory Solutions": {
      ...
      image: "/mindray_pictures/diagnostic-laboratory-solutions/mindray-bs-240-pro-chemistry-analyzer.png",
      keyFeatures: [
    ...
    "Diagnostic Imaging & Radiology": {
      ...
      image: "/mindray_pictures/diagnostic-imaging-radiology/mindray-dc-70-ultrasound-system.png",
      keyFeatures: [
    ...
    "Critical Care & Operation Theatre": {
      ...
      image: "/mindray_pictures/critical-care-operation-theatre/mindray-benevent-a3-ventilator.png",
      keyFeatures: [
    ...
    "Medical Consumables & Reagents": {
      ...
      image: "/medical_consumables_reagents/medical_consumables.png",
      keyFeatures: [
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-8" style={{letterSpacing: '-0.02em'}}>Benefits</h2>
              <div className="space-y-4">
