      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center space-y-8">
          ...
          >
            ...
            {/* Logo */}
            <div className="relative w-32 h-32 md:w-40 md:h-40 bg-white rounded-2xl shadow-2xl p-6 flex items-center justify-center">
              <img 
            ...
            {/* Rotating Medical Cross Decoration */}
            <motion.div
              className="absolute -top-2 -right-2 w-8 h-8 bg-green-500 rounded-full flex items-center justify-center text-white text-xl font-bold shadow-lg"
              animate={{ rotate: 360 }}
